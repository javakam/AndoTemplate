...
public class ScaleCircleNavigator extends View implements IPagerNavigator, NavigatorHelper.OnNavigatorScrollListener {
    ...
    private void init(Context context) {
        ...
        mMinRadius = IndicatorUtils.dip2px(context, 3);
        mMaxRadius = IndicatorUtils.dip2px(context, 5);
    ...
    protected void onDraw(Canvas canvas) {
        for (int i = 0, j = mCirclePoints.size(); i < j; i++) {
            ...
            mPaint.setColor(IndicatorUtils.eval((radius - mMinRadius) / (mMaxRadius - mMinRadius), mNormalCircleColor, mSelectedCircleColor));
