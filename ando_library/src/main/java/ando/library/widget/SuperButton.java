...
public class SuperButton extends AppCompatButton {
    ...
    private static final int defaultColor = 0x20000000;
    ...
    private static final int GRADIENT_LINEAR = 0;
    //"radial"	辐射渐变。startColor即辐射中心的颜色
    private static final int GRADIENT_RADIAL = 1;
    //"sweep"	扫描线渐变。
    ...
    private void getAttr(AttributeSet attrs) {
        ...
        gradientType = typedArray.getInt(R.styleable.SuperButton_sGradientType, GRADIENT_LINEAR);
