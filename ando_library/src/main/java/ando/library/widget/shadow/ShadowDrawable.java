...
import static ando.toolkit.ext.DimensionsExtKt.dp2px;

/**
 * 可以方便地生成圆角矩形/圆形的阴影
 * <pre>
 *     1.默认样式
 *     <com.xxx.ShadowTextView/ShadowButton
...
public class ShadowDrawable extends Drawable {
    ...
    public static ShadowDrawable fromAttributeSet(Context context, AttributeSet attrs) {
        ...
        int shadowRadius = typedArray.getDimensionPixelSize(R.styleable.ShadowDrawable_sd_shadowRadius, dp2px(context, 8F));
        ...
        int shapeRadius = typedArray.getDimensionPixelSize(R.styleable.ShadowDrawable_sd_shapeRadius, dp2px(context, 5F));
        ...
        int bgColor = typedArray.getColor(R.styleable.ShadowDrawable_sd_bgColor, Color.WHITE);
