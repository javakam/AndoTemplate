...
class GridItemDecoration internal constructor(builder: Builder) : RecyclerView.ItemDecoration() {
    ...
    override fun getItemOffsets(
        ...
        val spanIndex = layoutManager.spanSizeLookup.getSpanIndex(itemPosition, spanCount)
    ...
    override fun onDraw(c: Canvas, parent: RecyclerView, state: RecyclerView.State) {
        ...
        for (i in 0 until childCount) {
            ...
            val horizontalBRight =
                if (!isIncludeEdge && isInLastRowOrColumn(itemPosition, itemCount, spanCount, layoutManager))
    ...
    private fun isHideItemType(itemPosition: Int, parent: RecyclerView): Boolean {
        val itemType = parent.adapter?.getItemViewType(itemPosition) ?: -1
    ...
    private fun isInLastRowOrColumn(
        ...
        if (lastPosition - itemPosition < spanCount) {
            ...
            for (i in lastPosition - 1 downTo lastPosition - spanCount) {
                ...
                val spanIndex = layoutManager.spanSizeLookup.getSpanIndex(i, spanCount)
