...
public class SwitchButton extends CompoundButton {
    ...
    private static final int[] STATE_CHECKED_PRESSED = new int[]{android.R.attr.state_checked, android.R.attr.state_enabled, android.R.attr.state_pressed};
    private static final int[] STATE_UNCHECKED_PRESSED = new int[]{-android.R.attr.state_checked, android.R.attr.state_enabled, android.R.attr.state_pressed};
    ...
    private void init(AttributeSet attrs) {
        ...
        if (typedArray != null) {
            thumbDrawable = SwitchButtonUtils.INSTANCE.getDrawableAttrRes(getContext(), typedArray, R.styleable.SwitchButton_swb_thumbDrawable);
            ...
            backDrawable = SwitchButtonUtils.INSTANCE.getDrawableAttrRes(getContext(), typedArray, R.styleable.SwitchButton_swb_backDrawable);
        ...
        if (!mIsThumbUseDrawable && mThumbColor == null) {
            mThumbColor = SwitchButtonUtils.INSTANCE.generateThumbColorWithTintColor(mTintColor);
        ...
        if (!mIsBackUseDrawable && mBackColor == null) {
            mBackColor = SwitchButtonUtils.INSTANCE.generateBackColorWithTintColor(mTintColor);
            mCurrBackColor = mBackColor.getDefaultColor();
            mNextBackColor = mBackColor.getColorForState(STATE_CHECKED_PRESSED, mCurrBackColor);
        }
    ...
    protected void drawableStateChanged() {
        ...
        int[] nextState = isChecked() ? STATE_UNCHECKED_PRESSED : STATE_CHECKED_PRESSED;
        ColorStateList textColors = getTextColors();
        if (textColors != null) {
            int defaultTextColor = textColors.getDefaultColor();
            mOnTextColor = textColors.getColorForState(STATE_CHECKED_PRESSED, defaultTextColor);
            mOffTextColor = textColors.getColorForState(STATE_UNCHECKED_PRESSED, defaultTextColor);
        }
        if (!mIsBackUseDrawable && mBackColor != null) {
