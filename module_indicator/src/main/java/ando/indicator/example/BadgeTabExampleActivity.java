...
import ando.widget.indicator.usage.badge.BadgeAnchor;
import ando.widget.indicator.usage.badge.BadgePagerTitleView;
import ando.widget.indicator.usage.badge.BadgeRule;
    ...
    private void initMagicIndicator1() {
        ...
        commonNavigator.setAdapter(new CommonNavigatorAdapter() {
            ...
            public IPagerTitleView getTitleView(Context context, final int index) {
                ...
                // set badge position
                if (index == 0) {
                    badgePagerTitleView.setXBadgeRule(new BadgeRule(BadgeAnchor.CONTENT_LEFT, -IndicatorUtils.dip2px(context, 6)));
                    badgePagerTitleView.setYBadgeRule(new BadgeRule(BadgeAnchor.CONTENT_TOP, 0));
                } else if (index == 1) {
                    badgePagerTitleView.setXBadgeRule(new BadgeRule(BadgeAnchor.CONTENT_RIGHT, -IndicatorUtils.dip2px(context, 6)));
                    badgePagerTitleView.setYBadgeRule(new BadgeRule(BadgeAnchor.CONTENT_TOP, 0));
                } else if (index == 2) {
                    badgePagerTitleView.setXBadgeRule(new BadgeRule(BadgeAnchor.CENTER_X, -IndicatorUtils.dip2px(context, 3)));
                    badgePagerTitleView.setYBadgeRule(new BadgeRule(BadgeAnchor.CONTENT_BOTTOM, IndicatorUtils.dip2px(context, 2)));
                }
        ...
        titleContainer.setDividerPadding(IndicatorUtils.dip2px(this, 15));
        titleContainer.setDividerDrawable(ContextCompat.getDrawable(BadgeTabExampleActivity.this, R.drawable.simple_splitter));
    ...
    private void initMagicIndicator2() {
        ...
        commonNavigator.setAdapter(new CommonNavigatorAdapter() {
            ...
            public IPagerIndicator getIndicator(Context context) {
                ...
                indicator.setYOffset(IndicatorUtils.dip2px(context, 39));
                indicator.setLineHeight(IndicatorUtils.dip2px(context, 1));
    ...
    private void initMagicIndicator4() {
        ...
        titleContainer.setDividerDrawable(new ColorDrawable() {
            ...
            public int getIntrinsicWidth() {
                return IndicatorUtils.dip2px(BadgeTabExampleActivity.this, 15);
            }
        });
        ViewPagerHelper.bind(magicIndicator, mViewPager);
    }
