...
import ando.widget.indicator.indicators.WrapPagerIndicator;
...
import ando.widget.indicator.usage.navigator.titles.ColorFlipPagerTitleView;
...
public class ScrollableTabExampleActivity extends AppCompatActivity {
    ...
    private void initMagicIndicator1() {
        ...
        int padding = IndicatorUtils.getScreenWidth(this) / 2;
    ...
    private void initMagicIndicator7() {
        ...
        commonNavigator7.setAdapter(new CommonNavigatorAdapter() {
            ...
            public IPagerIndicator getIndicator(Context context) {
                LinePagerIndicator indicator = new LinePagerIndicator(context);
                indicator.setMode(LinePagerIndicator.MODE_EXACTLY);
                indicator.setLineHeight(IndicatorUtils.dip2px(context, 6));
                indicator.setLineWidth(IndicatorUtils.dip2px(context, 10));
                indicator.setRoundRadius(IndicatorUtils.dip2px(context, 3));
                indicator.setStartInterpolator(new AccelerateInterpolator());
